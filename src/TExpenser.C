...
// constants
const unsigned NCATEGORIES = 13;
TString CATEGORIES[]  = {"Food", "Restaurant", "Flat", "Cash", "Music equipment", "Books", "Clothes", "Presents", "Travel", "Transport HH", "Business trip", "Degussa", "Other"};
