...
// ========== constants ========== //
const unsigned NCATEGORIES = 22;
TString CATEGORIES[]  = {"Food", "Restaurant", "Flat", "Cash", "Car", "Music equipment", "Books", "Clothes", "Entertainment", "Presents", "Travel", "Transport HH", "Business trip", "Degussa", "Sparda Credit", "Wilster", "Wilster house purchase", "Piano lessons", "Category unknown", "No record", "Lend", "Other"};
